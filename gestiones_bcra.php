                        ...
                        <div id="posts" class="post-grid row grid-container gutter-40 has-init-isotope">
                            ...
                            <div class="entry event col-12">
                                <div class="grid-inner row align-items-center no-gutters p-4">
                                    ...
                                    <div class="col-lg-8 col-md-6" style="display: inline-block;">

                                        <p> "A la angustia por la pandemia le sumamos la
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 float-right p-4">
                                    ...
                                    <div class="entry-image col-md-4 mb-md-0">
                                        <a href="http://www.redcame.org.ar/novedades/8026/la-falta-de-colaboracin-de-los-bancos-est-matando-a-las-pymes"
                                            target="_blank">
                                            <img src="imgs/bcra_colaboracion.jpg"
                                    ...
                                    <div class="col-md-8 pl-md-4">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                            <ol class="ml-5 text-left">
                                                <li>Que las entidades financieras
                                                    autoricen descubiertos automáticos en cuenta corriente
                                                    para cubrir los cheques de sus clientes, especialmente
                                                    de aquellos que siempre han cumplido. </li>
                                                <li>Que las tasas por esos descubiertos no superen el 20% anual, que
                                                    es
                                                    la tasa de referencia que ofrece el Gobierno. </li>
                                                <li>Que el Banco Central adecúe las normativas para
                                                    posibilitar esa operatoria. </li>
                                                <li>Que, si es necesario,
                                                    sea el mismo Banco Central quien garantice los fondos
                                                    para que pueda sostenerse la cobertura de cheques. </li>
                                                <li>Que los bancos garanticen rapidez para dar los
                                                    créditos que autorizó el Gobierno en el paquete de
                                                    medidas reciente.</li>
                                                <ol>
                                                    </p>
                                                    <a href="http://www.redcame.org.ar/novedades/8026/la-falta-de-colaboracin-de-los-bancos-est-matando-a-las-pymes"
                                                        target="_blank" class="button button-xlarge text-right">Ver
