    ...
    <?php include "bienvenida.html"; ?>
        ...
        <div id="section-about" class="center page-section col-lg-12 col-md-12">
          ...
          <div class="container clearfix">
            ...
            <p class="lead mx-auto bottommargin" >Creció un 80% la cantidad de personas que se capacitaron a distancia en nuestra oferta regular, en relación a 2019.</p>
            <p class="lead mx-auto bottommargin" >Registramos un incremento del 72% en los egresos de las Diplomaturas de nuestra Escuela de Negocios, en relación con 2019.</p>
            ...
            <p>- Diplomatura en Gestión de Recursos Humanos para Pymes</br>
              ...
              -	Diplomatura en Desarrollo Integral de Franquicias (certificada por AAMyF)</br></br>
              ...
              <div class="row col-mb-30 mb-5">
                ...
                <div class="col-md-4">
                  <div class="feature-box fbox-small fbox-effect">
                    ...
                    <div class="fbox-content">
                      <div class="counter color"><span data-from="1" data-to="40" data-refresh-interval="5" data-speed="1600">16</span> </div>
                     
                      <p><bold class="display-5 color font-weight-medium">Videoconferencias</bold> diarias con más de 5.200 participantes</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="feature-box fbox-small fbox-effect">
                    ...
                    <div class="fbox-content">
                      <div class="counter color"><span data-from="1" data-to="3" data-refresh-interval="10" data-speed="1600">7</span> </div>
                     
                      <p><bold class="display-5 color font-weight-medium">Programas específicos</bold> sobre “Cómo implementar el comercio electrónico en la Pyme”, “Cómo gestionar las ventas del Negocio con herramientas digitales” y “Cómo implementar una oficina virtual” donde participaron en total más de 600 personas.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="feature-box fbox-small fbox-effect">
                    ...
                    <div class="fbox-content">
                      <div class="counter color"><span data-from="1" data-to="245" data-refresh-interval="10" data-speed="1600">58</span> </div>
                     
                      <p><bold class="display-5 color font-weight-medium">videoconferencias</bold> a solicitud de las Entidades de la red CAME que representaron capacitar a más de 9.000 personas en todo el país.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="feature-box fbox-small fbox-effect">
                    ...
                    <div class="fbox-content">
                      <div class="counter color"><span data-from="1" data-to="2100" data-refresh-interval="300" data-speed="1600">7</span> </div>
                     
                      <p><bold class="display-5 color font-weight-medium">actividades</bold> de capacitación realizadas por las entidades adheridas a CAME, con una participación de 97.450 personas. 
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="row justify-content-between">
            ...
            <div class="col-lg-5 col-md-6 mt-0 mt-md-4">
                <div class="feature-box fbox-plain fbox-sm">
                  ...
                  <div class="fbox-content">
                    <h3>ALIANZAS Y ACTIVIDADES CON EL SECTOR PÚBLICO</h3>
                    <p>
                    • Integramos la Red de la Economía del Conocimiento para las habilidades del futuro, creada por la Subsecretaría de Economía del Conocimiento del Ministerio de Desarrollo Productivo de la Nación. El objetivo general es impulsar un espacio de articulación entre los distintos sectores de la Economía del Conocimiento y la Industria 4.0 a los fines de debatir y planificar políticas públicas que promuevan la capacitación y actualización de conocimientos, saberes, habilidades y aptitudes de recursos humanos para el desarrollo económico y la reactivación económica.</br>
                    • CAME fue designada para formar parte del Consejo Nacional de Calidad de la Educación por parte del ministro de Educación de la Nación, Nicolás Trotta. 
