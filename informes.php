                        ...
                        <div class="row justify-content-between mt-4 mb-4">
                            ...
                            <div class="col-lg-4 col-md-6 my-4" data-animate="bounceInUp" data-delay="150">
                                ...
                                <p>
                                    ...
                                    y por zona
                                    de incumbencia, en consonancia con nuestra amplitud representativa y nuestra apuesta
                                    por seguir
                ...
                <div class="center page-section col-lg-12 col-md-12 mt-5 mb-5">
                    <div class="container clearfix">
                        ...
                        <p>Desde el sector de Estadísticas e Informes relevamos y analizamos la información
                            ...
                            Minoristas, Índice de Producción Industrial Pyme (IPIP), Índice de Precios en Origen y
                            Destino, y
                            estudios específicos que buscan captar las singularidades de los sectores y hacer más
                            exhaustivo
                            el análisis, por ejemplo, los monitores de exportación y las cadenas de valor. A su vez, se
                            generan
                            informes en conjunto con Mujeres Empresarias, Jóvenes Empresarios, y Financiamiento, con
                            perspectivas
                            específicas de cada sector.
                        </p>
                        <p>Asimismo, durante el año 2020, y debido a la pandemia se realizaron estudios que nos
                            permitieron
                            conocer el impacto que esto provocó en las pequeñas y medianas empresas. Para ello, <bold>
                                medimos más de 1500
                                comercios, industrias, productores de las economías regionales, jóvenes empresarios y
                                mujeres empresarias,</bold>
                            en los <bold>cinco relevamientos</bold> realizados con el objetivo de dimensionar los
  ...
  ?>
    ...
    var config = {
        ...
        data: {
            ...
            labels: ["Muy buena", "Buena", "Regular"],
        },
        options: {
            responsive: true,
            legend: {
