<div id="mision_vision_valores" class="row section d-flex align-items-center m-0 p-0"
    style="background-image: url('imgs/fondo_1.jpg');" data-bottom-top="background-position:0px -400px;"
    ...
    <div class="col-md-4 my-4 center col-padding">
        <i class="i-plain i-large mx-auto icon-diamond color" style="cursor: default"></i>
        <h3 class="m-0">VALORES</h3>
        <p class="text-center">
