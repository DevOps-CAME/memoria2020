                ...
                <div class="center page-section col-lg-12 col-md-12">
                    ...
                    <div class="container clearfix">
                        ...
                        <p class="lead mx-auto bottommargin">Durante el 2020, con el propósito de morigerar la situación
                            de las pymes industriales afectadas por las medidas de prevención que se dispusieron ante la
                            pandemia, desde el Sector Industrial elaboramos un completo informe que presentamos al Poder
                            Ejecutivo planteando los principales desafíos en los ámbitos laborales, económicos y
                        ...
                        <div class="col-md-12">
                            <div class="row col-mb-30 mb-5">
                                <div class="col-lg-10 col-md-10 mb-0">
                                    <h2>En 2020, además, realizamos:</h2>
                                </div>
                                <div class="clear"></div>
                                ...
                                <div class="col-md-4">
                                    <div class="feature-box fbox-small fbox-effect">
                                        ...
                                        <div class="fbox-content">
                                            <div class="counter color"><span data-from="1" data-to="12"
                                                    data-refresh-interval="10" data-speed="1600">12</span> </div>

                                            <p>
                                                <bold class="display-5 color font-weight-medium">encuentros de Comité
                                                    Industrial.</bold>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="feature-box fbox-small fbox-effect">
                                        ...
                                        <div class="fbox-content">
                                            <div class="counter color"><span data-from="1" data-to="32"
                                                    data-refresh-interval="10" data-speed="1600">32</span> </div>

                                            <p>
                                                <bold class="display-5 color font-weight-medium">circulares</bold> de
                                ...
                                <div class="col-md-4">
                                    <div class="feature-box fbox-small fbox-effect">
                                        ...
                                        <div class="fbox-content">
                                            ...
                                            <p>
                                                <bold class="display-5 color font-weight-medium">informes del índice de
                                    ...
                                    <div class="feature-box fbox-small fbox-effect">
                                        ...
                                        <div class="fbox-content">
                                            ...
                                            <p> reunión especial de Comité, realizada de manera virtual, en
                                                conmemoración del <bold class="display-5 color font-weight-medium">Día
                                                    de la Industria.
