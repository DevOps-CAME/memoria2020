                            ...
                            <div class="col-md-6">
                                <h2 class="display-4 font-weight-semibold ls--2 mt-3">
                                    ...
                                    <span class="text-rotater" data-separator="|" data-rotate="fadeIn"
                                        data-speed="2000">
                                        <span class="t-rotate">Comercio y Servicios|Turismo|Industria|Parques
                                            Industriales|Economías Regionales|Construcción|Mujeres Empresarias|Jóvenes
                                        </span>
                                    </span>
                            ...
                            <div class="col-md-6 pr-5">
                                ...
                                <div class="row">
                                    <div class="col-6 col-sm-6 mb-4">
                                        ...
                                        <h4 class="mt-0 font-weight-medium">Gestiones realizadas para morigerar impacto
                                            de la pandemia</h4>
                                    </div>
                                    ...
                                    <div class="col-6 col-sm-6 mb-4">
                                        ...
                                        <h4 class="mt-0 font-weight-medium">Personas capacitadas a través de la oferta
                                    ...
                                    <div class="col-6 col-sm-6 mb-4">
                                        ...
                                        <h4 class="mt-0 font-weight-medium">Nuevos seminarios web (webinars) para
                                    ...
                                    <div class="col-6 col-sm-6 mb-4">
                                        ...
                                        <h4 class="mt-0 font-weight-medium">Reuniones de Consejo Directivo, para
                                            fortalecer la gremial
                                            empresaria y generar sinergias que resulten en propuestas concretas para la
                                            defensa del sector.
                                        </h4>
                                    </div>
                                </div>
