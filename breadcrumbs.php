...
$array_urls = array(
    ...
    'comercio_servicios.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Sectores / <a href="comercio_servicios.php" class="actual">Comercio y Servicios</a>','nombre'=>'Comercio y Servicios'),
    'turismo.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Sectores / <a href="turismo.php" class="actual">Turismo</a>','nombre'=>'Turismo'),
    'industria.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Sectores / <a href="industria.php" class="actual">Industria</a>','nombre'=>'Industria'),
    'parques_industriales.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Sectores / <a href="parques_industriales.php" class="actual">Parques Industriales</a>','nombre'=>'Parques Industriales'),
    'economias_regionales.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Sectores / <a href="economias_regionales.php" class="actual">Economías Regionales</a>','nombre'=>'Economías Regionales'),
    'construccion.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Sectores / <a href="construccion.php" class="actual">Construcción</a>','nombre'=>'Construcción'),
    'mujeres.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Sectores / <a href="mujeres.php" class="actual">Mujeres Empresarias</a>','nombre'=>'Mujeres Empresarias'),
    'came_joven.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Sectores / <a href="came_joven.php" class="actual">CAME Joven</a>','nombre'=>'CAME Joven'),
    'rse.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Secretarías / <a href="rse.php" class="actual">RSE</a>','nombre'=>'RSE'),
    'capacitacion.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Secretarías / <a href="capacitacion.php" class="actual">Capacitación</a>','nombre'=>'Capacitación'),
    'financiamiento.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Secretarías / <a href="financiamiento.php" class="actual">Financiamiento y Competitividad</a>','nombre'=>'Financiamiento y Competitividad'),
    'comex.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Secretarías / <a href="comex.php" class="actual">Comercio Exterior</a>','nombre'=>'Comercio Exterior'),
    'rondas.php'  => array( 'url' => '<a href="index.php">Inicio</a> / Secretarías / <a href="rondas.php" class="actual">Rondas de Negocios</a>','nombre'=>'Rondas de Negocios')
    );
...
<div class="breadcrumbs mt-0 mb-4">
    <div class="container clearfix col-md-12 d-flex align-content-center flex-wrap">
