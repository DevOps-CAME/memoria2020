		...
		============================================= -->
                <div class="center page-section col-lg-12 col-md-12">
                    ...
                    <div class="container clearfix">
                        ...
                        <h2 class="subtitulo">Gestión para fortalecer el desarrollo de Parques Industriales en todo el
                            país
                        </h2>

                        <p class="lead mx-auto bottommargin">A los efectos de promover a un sector pujante del aparato
                            ...
                            para la implementación de programas, proyectos e instrumentos, que motoricen su desarrollo,
                            así como el de las empresas que los componen y el de las localidades en las que estas
                            unidades productivas se radican.
                            ...
                            <div class="row col-mb-30 mb-5">
                                ...
                                <div class="col-md-4">
                                    <div class="feature-box fbox-small fbox-effect">
                                        ...
                                        <div class="fbox-content">
                                            <div class="counter color"><span data-from="1" data-to="58"
                ...
                <div class="container clearfix col-lg-12 col-md-12">
                    <div class="row justify-content-between">
                        <div class="col-lg-10 col-md-10 mb-0">
                            <h2>Asimismo, llevamos a cabo acciones y encuentros estratégicos para atender la situación
                                de nuestras entidades asociadas:</h2>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="col-lg-6 col-md-4 my-4">
                            ...
                            <p class="text-muted">
                                Reunión entre el Ministro de Industria, Trabajo y Comercio de la Provincia de Corrientes
                                y las autoridades de la Federación Económica de Corrientes, la Asociación de la
                                Producción, Industria y Comercio de Corrientes y la Federación Empresaria de Corrientes.
                        ...
                        <div class="col-lg-6 col-md-4 my-4">
                            <i class="icon-line-check-circle color ml-0 mb-4 i-plain d-block float-none"></i>
                            <p class="text-muted">
                                Audiencia con el Dr. Gerardo Gabriel Girón, Subsecretario de Articulación Territorial, y
                                el Sr. Manuel Luaces, jefe de Agencia Territorial San Martin, ambos funcionarios del
                                Ministerio de Trabajo de la Nación, en el marco de la Presentación de Programas:
                                Acciones de Entrenamiento para el Trabajo (EPT) y Programa de Inserción Laboral (PIL)
                                modalidad común / PIL Empalme.
                        ...
                        <div class="col-lg-4 col-md-4 my-4">
                            ...
                            <p class="text-muted">
                                ...
                                Industriales” junto a Red Parques. Se contó con la participación de la Lic. Mercedes La
                        ...
                        <div class="col-lg-6 col-md-4 my-4">
                            <i class="icon-line-check-circle color ml-0 mb-4 i-plain d-block float-none"></i>
                            <p class="text-muted">
                                Coorganización y participación del panel “Desarrollo provincial de parques industriales”
                                en EPIBA 2020, en el cual se abordó la temática de la planificación y desarrollo de
                                agrupamientos como herramienta valiosa para el impulso de políticas públicas de los
                                gobiernos provinciales. Presencia de Gobernadores de Mendoza y Córdoba.
