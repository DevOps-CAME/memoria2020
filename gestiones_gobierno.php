		...
		============================================= -->
                <div class="center page-section col-lg-12 col-md-12">
                    <div class="container clearfix">
                        ...
                        <p class="lead mx-auto bottommargin">
                            ...
                            <bold>Comité de Presidencia,</bold> asimismo, se
                ...
                <div class="container clearfix">
                    <div class="row col-md-12">
                        <div class="row col-md-6 justify-content-between center">
                        ...
                        <div class="col-md-6 justify-content-between center">
                            <div class="feature-box fbox-center fbox-outline fbox-lg fbox-effect fbox-dark">
                                <div class="fbox-icon">
                                    <a href="#"><i class="icon-flag21"></i></a>
                                </div>
                                <div class="fbox-content">
