        ...
        <div class="container clearfix col-lg-12 col-md-12">
          <div class="row justify-content-between">
            ...
            <div class="col-lg-4 col-md-4 my-4">
              ...
              <p class="text-muted">
              Con el propósito de conocer las demandas de cada sector, organizamos <bold class="color">reuniones virtuales periódicas</bold> con productores agropecuarios y agroindustriales nucleados en la Mesa Chica de Economías Regionales y la Mesa Agroalimentaria.               </p>
            </div>
            <div class="col-lg-4 col-md-4 my-4">
              <i class="icon-line-check-circle color ml-0 mb-4 i-plain d-block float-none"></i>
              <p class="text-muted">
              Entre las actividades realizadas junto con los productores se destacaron los <bold class="color">webinarios,</bold> que contaron con un alto nivel de participación a nivel nacional e internacional.
              </p>
            </div>
            <div class="col-lg-4 col-md-4 my-4">
              <i class="icon-line-check-circle color ml-0 mb-4 i-plain d-block float-none"></i>
              <p class="text-muted">
             Desarrollamos encuestas y relevamientos que nos permitieron elaborar <bold class="color">diagnósticos,</bold> en distintos momentos de la pandemia, sobre el estado de la cadena de pagos, de provisión, requerimientos de capital de trabajo, etc.; información estratégica que fue elevada al Ministerio de Agricultura, Ganadería y Pesca de la Nación. 
                    </p>
            </div>
            <div class="col-lg-6 col-md-4 my-4">
              <i class="icon-line-check-circle color ml-0 mb-4 i-plain d-block float-none"></i>
              <p class="text-muted">
              <bold class="color">Gestionamos</bold> en favor de la falta de disponibilidad de efectivo y la multiplicidad de permisos de circulación, temas estratégicos para la actividad que requirieron la intervención del sector de Economías Regionales de CAME: se logró la aprobación de un permiso único de circulación válido en todo el territorio nacional así como restablecer el funcionamiento del sistema bancario para poder pagar los salarios de los trabajadores temporarios (no bancarizados) y comprar diversos insumos que requerían pago de contado (gasoil, por ejemplo).                            </p>
            </div>
            <div class="col-lg-6 col-md-4 my-4">
              <i class="icon-line-check-circle color ml-0 mb-4 i-plain d-block float-none"></i>
              <p class="text-muted">
              Como miembro permanente de la Comisión Nacional de Trabajo Agrario (CNTA) y la Comisión Nacional de Emergencias y Desastres Agropecuarios (CNEyDA), el sector participó de los debates paritarios y analizó el alcance de diversas inclemencias climáticas sufridas a lo largo y ancho del país. En la CNTA, la postura de CAME fue clara: no permitir que durante la pospandemia sigan desapareciendo empresas, pudiendo así conservarse las fuentes de trabajo.</p>
            </div>
